...
const Games3 = () => {
  ...
  const stringArray = [['l', 'a', 'r', 'g', 'e'], ['r', 'i', 'v', 'a', 'l'], ['c', 'h', 'a', 'm', 'p'], ['c', 'h', 'a', 'i', 'r'],  ['s', 'p', 'a', 'c', 'e'], ['s', 't', 'a', 'm', 'p'], ['l', 'i', 'v', 'e', 's'], ['l', 'a', 'r', 'g', 'e'], ['r', 'i', 'v', 'a', 'l'], ['c', 'h', 'a', 'm', 'p'], ['c', 'h', 'a', 'i', 'r'],  ['s', 'p', 'a', 'c', 'e'], ['s', 't', 'a', 'm', 'p'], ['l', 'i', 'v', 'e', 's'], ['l', 'a', 'r', 'g', 'e'], ['r', 'i', 'v', 'a', 'l'], ['c', 'h', 'a', 'm', 'p'], ['c', 'h', 'a', 'i', 'r'],  ['s', 'p', 'a', 'c', 'e'], ['s', 't', 'a', 'm', 'p'], ['l', 'i', 'v', 'e', 's']]
  const stringArray2 = [['l', 'a', 'r', 'g', 'e'], ['r', 'i', 'v', 'a', 'l'], ['c', 'h', 'a', 'm', 'p'], ['c', 'h', 'a', 'i', 'r'],  ['s', 'p', 'a', 'c', 'e'], ['s', 't', 'a', 'm', 'p'], ['l', 'i', 'v', 'e', 's'], ['l', 'a', 'r', 'g', 'e'], ['r', 'i', 'v', 'a', 'l'], ['c', 'h', 'a', 'm', 'p'], ['c', 'h', 'a', 'i', 'r'],  ['s', 'p', 'a', 'c', 'e'], ['s', 't', 'a', 'm', 'p'], ['l', 'i', 'v', 'e', 's'], ['l', 'a', 'r', 'g', 'e'], ['r', 'i', 'v', 'a', 'l'], ['c', 'h', 'a', 'm', 'p'], ['c', 'h', 'a', 'i', 'r'],  ['s', 'p', 'a', 'c', 'e'], ['s', 't', 'a', 'm', 'p'], ['l', 'i', 'v', 'e', 's']]
  const [word, setWord] = useState(['t', 'i', 'g', 'e', 'r']);
  const [scramble, setScramble] = useState(['e', 't', 'i', 'g', 'r'])
